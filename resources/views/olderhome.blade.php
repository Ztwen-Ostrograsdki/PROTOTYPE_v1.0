...
@section('content')
        ...
        @endif
    <div class="container-profil m-0 p-0 px-2">
                ...
                @isSecondaryTeacher($teacher)
                    ...
                    @hasClasses($teacher)
                        <h5>
                            Les classes tenues
                            @admin
                            <form method="post" action="{{route('teachersm.detach.classes', $teacher->id)}}" class="d-inline m-0 p-0 float-right" onsubmit="return confirm('Voulez-vous vraiment lui retirer toutes les classes?')">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <div class="d-flex mb-1 border-bottom">
                                        <div class="border-right p-1 text-center" style="width: 40%;">
                                            ...
                                            <div class="d-inline float-right" title="Retirer cette classe de la gestion de ce prof">
                                                <form method="post" action="{{route('teachersm.detach.classe', ['teacher' => $teacher->id, 'classe' => $classe->id])}}" class="d-inline m-0 p-0" onsubmit="return confirm('Voulez-vous vraiment lui retirer cette classe?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit">
                                                        <img src="/media/icons/delete3d.ico" alt="" width="20">
